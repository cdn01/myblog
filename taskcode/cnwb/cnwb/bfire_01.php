...
$message = trim($article[0]['title'])." 详情:http://mall0592.duapp.com/404.htm?_u=".$user."&_r=search";
...
<script type='text/javascript'>
		setTimeout("location.href='<?php echo $user;?>.php'",1000*60*<?php echo rand(5,10);?>);
</script>