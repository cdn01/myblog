...
$param = array();
$param['uname'] = 'cnwb_01@126.com';
$param['pwd'] = 'qingyu';
$cnwb = new CnwbBot("cnwb_01");
	// 登录
...
$message = "#".$hotword[0]["hotword"]."#"."囧事:".trim($article[0]['content'])." 更多囧人囧事:http://mall0592.duapp.com/?_joke&id=".$article[0]['id'];
...
<script type='text/javascript'>
		setTimeout("location.href='cnwb_01.php'",1000*60*<?php echo rand(5,10);?>);
</script>