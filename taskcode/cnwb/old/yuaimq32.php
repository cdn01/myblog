...
$sql = "select * from article where char_length(title)>10 and gettime > '".date("Y-m-d",strtotime("-1 day"))." ' and image_dir is not null order by postnum asc , id desc  limit 1 ";
$article = query($sql);
