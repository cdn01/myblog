...
require 'header.php';
set_time_limit(0);
$url = "http://icare.qq.com/dj/timeList.php?cid=5&subid=0&apiType=16&apiHost=http%3A%2F%2Fapi.t.qq.com";
...
function insertContent($t){
	...
	values ('{$pic_arr}','".str_conv($t['wbdata']['content'])."','{$t['akdata']['hot']}','{$t['akdata']['id']}','{$t['akdata']['img']}','".str_conv($t['akdata']['summary'])."','{$t['akdata']['timestamp']}','".str_conv($t['akdata']['title'])."','{$t['akdata']['wbid']}')";
	mysql_query($sql);
...
setTimeout("location.href='getlist_wenhua.php'",1000*60*10);
</script>
