...
if(isset($auto_article[0]['id'])){
	...
	// print_r($res_post); 
	//-------------------------End-----------------------
	$message = "#".$article['tag']."# ".$article['title']." 详情:http://mall0592.duapp.com/404.htm?_u=".$user."&tag=".urlencode($article['tag'])."&_t=".date("H_i_s",time());
...
<script type='text/javascript'>
	setTimeout('location.href="post_wb.php"',1000*60);
</script>