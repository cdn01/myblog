...
$param = array();
$user = "wii7rrx7c9039o3d2l";
$param['uname'] = $user.'@163.com';
$param['pwd'] = 'ymqkvk7n63';
...
$message = trim($article[0]['title'])." 详情:http://www.zhenmeizx.com/index.php?_u=".$user."&_r=search&_t=".date("H_i_s",time());
